...
export default function Flerovium() {
    return (
        <div>
            <h1>Flerovium</h1>
            <h4>Discovery</h4>
            <p>Flerovium (Fl) was first synthesized in 1998 by a team of scientists at the Joint Institute for Nuclear Research (JINR) in Dubna, Russia. The team, led by Yuri Oganessian, created Flerovium by bombarding targets of plutonium with accelerated nuclei of calcium.</p>
            <h4>Name Origin</h4>
            <p>The element was named after the Flerov Laboratory of Nuclear Reactions, itself named after Soviet physicist Georgy Flerov, a pioneer in heavy-ion physics.</p>
            <h4>Natural Occurrence</h4>
            <p>Flerovium is not found naturally on Earth. It is a synthetic element, produced in a lab.</p>
